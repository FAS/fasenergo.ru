...
const mockContext = {
  ...
  SITE: {
    images: [
      { 'name': '/assets/images/test.jpg', 'width': 100, 'height': 150 },
      { 'name': '/assets/images/test2.png', 'width': 120, 'height': 170 },

      { 'name': '/assets/images/set.jpg', 'width': 2000, 'height': 2500 },
      { 'name': '/assets/images/set@500.jpg', 'width': 500, 'height': 550 },
      { 'name': '/assets/images/set@1000.jpg', 'width': 1000, 'height': 1500 },

      { 'name': '/assets/nope@images/set@1000.jpg', 'width': 1000, 'height': 1000 }
    ]
  }
}
