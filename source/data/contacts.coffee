module.exports = {
  ...
  main: {
    ...
    desc: null,
    address: [
      { index: 194044, city: 'Санкт-Петербург', street: 'п. Лахта, ул. Красных партизан, д. 10 литер А'}
    ],
    worktime: [
  ...
  representatives: {
    ...
    fasMoscow: {
      ...
      desc: null,
      address: [
        { index: 117449, city: 'Москва', street: 'ул. Карьер, дом 2А, строение 2'}
      ],
      worktime: null,
    ...
    fasEkaterinburg: {
      ...
      desc: null,
      address: [
        { index: 620075, city: 'Екатеринбург', street: 'ул. Ленина д. 50 литер Д оф. 128'}
      ],
      worktime: null,
    ...
    fasKazan: {
      ...
      desc: null,
      address: [
        { index: 420034, city: 'Казань', street: 'ул. Проточная д.8 офис 309'}
      ],
      worktime: null,
    ...
    fasNovosibirsk: {
      ...
      desc: null,
      address: [
        { index: 630091, city: 'Новосибирск', street: 'ул. Фрунзе, дом 5, оф.631'}
      ],
      worktime: null,
      phones: [
    ...
    fasKrasnodar: {
      ...
      desc: null,
      address: [
        { index: 350018, city: 'Краснодар', street: 'ул. Сормовская, д.7'}
      ],
      worktime: null,
